...
namespace Nassajis\AdobeConnect;
...
class AdobeConnectServiceProvider extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton('Nassajis\AdobeConnect\AdobeConnectClient', function ($app) {
        ...
        App::bind('adobe-connect', function(){
            return App::make('Nassajis\AdobeConnect\AdobeConnectClient');
        });
    }
    ...
    public function provides(){
        return ['Nassajis\AdobeConnect\AdobeConnectClient'];
    }
